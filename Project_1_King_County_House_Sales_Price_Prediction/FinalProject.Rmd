...
## Collection method described, data description, study background information. Correct and sufficient referencing of the data source and the method, codes used (3 mark + 3 marks)
...
Let’s first fit a model for ***price*** (y) with all 5 variables using the lm(). <br />

```{r}
full= lm(price ~ factor(bedrooms) + factor(bathrooms) + sqft_living + sqft_lot + factor(floors), data=kc_house)
```

## Discussion of possible relationships between variables and the relevance of the relationship in the context of the data. (2 marks)
...
## Descriptive statistics and Relative graphs, justifications and comments (3 marks + 3 marks)
...
## Model 1 (Linear model) - Model selection and variable selection approaches. Graphical and statistical tests of assumptions. Validity of each model (8 marks + 7 marks + 8 marks)
...
## Model 2 (Logistic model) - Model selection and variable selection approaches. Graphical and statistical tests of assumptions. Validity of each model (8 marks + 7 marks + 8 marks)
...
1. The error terms take on only two values, so they can’t possibly be normally distributed <br />
...
## Model 3 (Poisson model) - Model selection and variable selection approaches. Graphical and statistical tests of assumptions. Validity of each model (8 marks + 7 marks + 8 marks)
...
## Model 4 (GLM model with log transformed gamma distributed response) - Model selection and variable selection approaches. Graphical and statistical tests of assumptions. Validity of each model (8 marks + 7 marks + 8 marks)
...
## Detailed conclusion on the most appropriate model including context. Justify why and give at least two examples of model predictions with discussion. (7 marks)
...
All codes are embedded in this report.
